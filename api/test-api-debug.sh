...
test_outlet_endpoints() {
    ...
    # Dashboard
    run_test "Outlet Dashboard" "curl -s -H '${auth_header}' '${API_URL}/outlet/dashboard'" 200
...
test_error_cases() {
    ...
    run_test "Wrong HTTP method" "curl -s -X PUT '${API_URL}/health'" 405
...
test_performance() {
    ...
    if [[ $response_time -lt 1000 ]]; then
        ...
        print_error "Health endpoint too slow" "${response_time}ms"
    fi
